...
<head>
  ...
  <title>Database Error - Hotel</title>
...
<body>
  <div class="error-container text-center">
    ...
    <div class="error-code"><i class="bi bi-database-x"></i></div>
    <div class="error-message">A database error occurred.</div>
    ...
    <div class="mt-4 text-muted small">Error details: Please contact the site administrator.</div>
  </div>
