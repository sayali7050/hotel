...
<head>
  ...
  <title>Terms - LuxuryHotel Bootstrap Template</title>
...
<body class="terms-page">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Pages</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="<?php echo base_url('terms'); ?>" class="active">Terms Page</a></li>
  ...
  <main id="main-content" role="main">
    ...
    <section class="terms-of-service section" aria-label="Terms and Conditions" role="region">
