...
<head>
  ...
  <title>About - LuxuryHotel Bootstrap Template</title>
          ...
          <div class="col-lg-6">
            <div class="about-visuals">
              <div class="main-image" data-aos="zoom-in" data-aos-delay="200">
                <img src="<?php echo base_url('assets/img/hotel/showcase-3.webp'); ?>" alt="Hotel Luxury Suite" class="img-fluid">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="room-card">
              <div class="room-image">
                <img src="<?php echo base_url('assets/img/hotel/room-1.webp'); ?>" alt="Deluxe Room" class="img-fluid">
                <div class="room-overlay">
                  <a href="<?php echo base_url('room-details'); ?>" class="btn-explore">Explore Room</a>
                </div>
              </div>
              <div class="room-content">
                ...
                <div class="room-footer">
                  ...
                  <a href="<?php echo base_url('room-details'); ?>" class="btn-view-details">View Details</a>
                </div>
              </div>
            </div>
          </div><!-- End Room Card -->
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="250">
            <div class="room-card">
              <div class="room-image">
                <img src="<?php echo base_url('assets/img/hotel/room-5.webp'); ?>" alt="Executive Suite" class="img-fluid">
                <div class="room-overlay">
                  <a href="<?php echo base_url('room-details'); ?>" class="btn-explore">Explore Room</a>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="room-card">
              <div class="room-image">
                <img src="<?php echo base_url('assets/img/hotel/room-12.webp'); ?>" alt="Family Room" class="img-fluid">
                <div class="room-overlay">
                  <a href="<?php echo base_url('room-details'); ?>" class="btn-explore">Explore Room</a>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="350">
            <div class="room-card">
              <div class="room-image">
                <img src="<?php echo base_url('assets/img/hotel/room-8.webp'); ?>" alt="Standard Room" class="img-fluid">
                <div class="room-overlay">
                  <a href="<?php echo base_url('room-details'); ?>" class="btn-explore">Explore Room</a>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="400">
            <div class="room-card">
              <div class="room-image">
                <img src="<?php echo base_url('assets/img/hotel/room-15.webp'); ?>" alt="Ocean View Suite" class="img-fluid">
                <div class="room-overlay">
                  <a href="<?php echo base_url('room-details'); ?>" class="btn-explore">Explore Room</a>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="450">
            <div class="room-card">
              <div class="room-image">
                <img src="<?php echo base_url('assets/img/hotel/room-3.webp'); ?>" alt="Presidential Suite" class="img-fluid">
                <div class="room-overlay">
                  <a href="<?php echo base_url('room-details'); ?>" class="btn-explore">Explore Room</a>
                </div>
              </div>
        ...
        <div class="text-center mt-5" data-aos="fade-up" data-aos-delay="500">
          <a href="<?php echo base_url('rooms'); ?>" class="btn-view-all-rooms">View All Rooms &amp; Suites</a>
        </div>
