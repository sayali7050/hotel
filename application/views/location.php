    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?php echo base_url('location'); ?>" class="active">Location</a></li>
  ...
  <main class="main">
    ...
    <section id="hotel-location" class="hotel-location section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 mb-5 mb-lg-0" data-aos="fade-right" data-aos-delay="200">
            <div class="map-wrapper" style="height: 100%">
              <iframe style="height: 100%" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d48389.78314118045!2d-74.006138!3d40.710059!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a22a3bda30d%3A0xb89d1fe6bc499443!2sDowntown%20Conference%20Center!5e0!3m2!1sen!2sus!4v1676961268712!5m2!1sen!2sus" frameborder="0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          ...
          <div class="col-lg-4" data-aos="fade-left" data-aos-delay="300">
            <div class="location-info">
              ...
              <p class="location-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.</p>
        ...
        <!-- Nearby Attractions -->
        <div class="row nearby-attractions" data-aos="fade-up" data-aos-delay="400">
          <div class="col-12">
            <h3 class="attractions-title">What's Nearby</h3>
            <p class="attractions-subtitle">Discover the best attractions within walking distance from our hotel</p>
          </div>

          <div class="col-lg-6 col-md-6 mb-4" data-aos="zoom-in" data-aos-delay="500">
            <div class="attraction-card">
              <div class="attraction-image">
                <img src="assets/img/hotel/location-1.webp" alt="Central Park" class="img-fluid">
              </div>
              <div class="attraction-content">
                <h5>Central Park</h5>
                <p class="distance"><i class="bi bi-geo-alt"></i> 0.3 miles - 5 min walk</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Perfect for morning jogs and afternoon picnics.</p>
              </div>
            </div>
          </div>

          <div class="col-lg-6 col-md-6 mb-4" data-aos="zoom-in" data-aos-delay="600">
            <div class="attraction-card">
              <div class="attraction-image">
                <img src="assets/img/hotel/location-2.webp" alt="Times Square" class="img-fluid">
              </div>
              <div class="attraction-content">
                <h5>Times Square</h5>
                <p class="distance"><i class="bi bi-geo-alt"></i> 0.8 miles - 12 min walk</p>
                <p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae.</p>
              </div>
            </div>
          </div>

          <div class="col-lg-6 col-md-6 mb-4" data-aos="zoom-in" data-aos-delay="700">
            <div class="attraction-card">
              <div class="attraction-image">
                <img src="assets/img/hotel/location-3.webp" alt="Broadway Theater District" class="img-fluid">
              </div>
              <div class="attraction-content">
                <h5>Broadway Theater District</h5>
                <p class="distance"><i class="bi bi-geo-alt"></i> 0.5 miles - 8 min walk</p>
                <p>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Experience world-class entertainment.</p>
              </div>
            </div>
          </div>

          <div class="col-lg-6 col-md-6 mb-4" data-aos="zoom-in" data-aos-delay="800">
            <div class="attraction-card">
              <div class="attraction-image">
                <img src="assets/img/hotel/location-4.webp" alt="Madison Square Garden" class="img-fluid">
              </div>
              <div class="attraction-content">
                <h5>Madison Square Garden</h5>
                <p class="distance"><i class="bi bi-geo-alt"></i> 1.2 miles - 15 min walk</p>
                <p>Donec rutrum congue leo eget malesuada. Home to concerts, sports events, and special performances.</p>
              </div>
            </div>
          </div>
        ...
        <div class="row transportation-section" data-aos="fade-up" data-aos-delay="900">
          <div class="col-12">
            <h3 class="transport-title">How to Get Here</h3>
          </div>
          ...
          <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="1100">
            <div class="transport-option">
              <div class="transport-icon">
          ...
          <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="1200">
            <div class="transport-option">
              <div class="transport-icon">
          ...
          <div class="col-lg-3 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="1300">
            <div class="transport-option">
              <div class="transport-icon">
