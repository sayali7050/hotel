      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Discover Our Property</h2>
            <p class="section-subheading">Experience the beauty and comfort of our hotel through stunning visuals</p>
          </div>
        </div>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-rooms">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-1.webp'); ?>" class="img-fluid" alt="Luxury Suite">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Luxury Suite</h4>
                    <p>Spacious rooms with premium amenities</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-1.webp'); ?>" class="glightbox gallery-link">
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-amenities">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-2.webp'); ?>" class="img-fluid" alt="Infinity Pool">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Infinity Pool</h4>
                    <p>Relax by our stunning rooftop pool</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-2.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-dining">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-3.webp'); ?>" class="img-fluid" alt="Fine Dining Restaurant">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Fine Dining Restaurant</h4>
                    <p>Exceptional cuisine in elegant setting</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-3.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-location">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-4.webp') ?>" class="img-fluid" alt="Stunning Views">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Breathtaking Views</h4>
                    <p>Panoramic vistas from every angle</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-4.webp') ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-rooms">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-5.webp'); ?>" class="img-fluid" alt="Deluxe Room">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Deluxe Room</h4>
                    <p>Comfort meets elegance</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-5.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-amenities">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-6.webp'); ?>" class="img-fluid" alt="Spa &amp; Wellness">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Spa &amp; Wellness</h4>
                    <p>Rejuvenate body and mind</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-6.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-dining">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-7.webp'); ?>" class="img-fluid" loading="lazy" alt="Rooftop Bar">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Rooftop Bar</h4>
                    <p>Cocktails with city views</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-7.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-rooms">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-8.webp'); ?>" class="img-fluid" loading="lazy" alt="Presidential Suite">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Presidential Suite</h4>
                    <p>Ultimate luxury experience</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-8.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-location">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-9.webp'); ?>" class="img-fluid" loading="lazy" alt="City Landmarks">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Prime Location</h4>
                    <p>Steps from major attractions</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-9.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-amenities">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-10.webp'); ?>" class="img-fluid" loading="lazy" alt="Hotel Lobby">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Grand Lobby</h4>
                    <p>Welcome to luxury and sophistication</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-10.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-amenities">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-11.webp'); ?>" class="img-fluid" loading="lazy" alt="Fitness Center">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Fitness Center</h4>
                    <p>State-of-the-art equipment</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-11.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-dining">
              <div class="gallery-wrapper">
                <img src="<?php echo base_url('assets/img/hotel/gallery-12.webp'); ?>" class="img-fluid" loading="lazy" alt="Breakfast Buffet">
                <div class="gallery-overlay">
                  <div class="gallery-content">
                    <h4>Breakfast Buffet</h4>
                    <p>Start your day right</p>
                    <a href="<?php echo base_url('assets/img/hotel/gallery-12.webp'); ?>" class="glightbox gallery-link">
                      <i class="bi bi-zoom-in"></i>
                    </a>
                  </div>
                </div>
