...
<body class="amenities-page">
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?php echo base_url('amenities'); ?>" class="active">Amenities</a></li>
  ...
  <main id="main-content" role="main">
    ...
    <!-- Amenities Section -->
    <section id="amenities" class="amenities section" aria-label="Hotel Amenities" role="region">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="amenity-card">
              <div class="amenity-image">
                <img src="<?php echo base_url('assets/img/hotel/amenities-1.webp') ?>" alt="Swimming Pool" class="img-fluid" loading="lazy">
                <div class="amenity-icon">
                  <i class="bi bi-water"></i>
                </div>
              </div>
              <div class="amenity-content">
                <h3>Outdoor Pool &amp; Spa</h3>
                <p>Relax in our stunning outdoor swimming pool surrounded by tropical landscapes. Our spa offers rejuvenating treatments to help you unwind and restore your energy.</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="amenity-card">
              <div class="amenity-image">
                <img src="<?php echo base_url('assets/img/hotel/amenities-2.webp') ?>" alt="Fitness Center" class="img-fluid" loading="lazy">
                <div class="amenity-icon">
              ...
              <div class="amenity-content">
                ...
                <p>Stay active during your stay with our fully equipped fitness center featuring modern cardio machines, free weights, and professional training equipment.</p>
                <div class="amenity-features">
                  <span class="feature-tag">Open 5AM-11PM</span>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="amenity-card">
              <div class="amenity-image">
                <img src="<?php echo base_url('assets/img/hotel/dining-3.webp') ?>" alt="Restaurant" class="img-fluid" loading="lazy">
                <div class="amenity-icon">
              ...
              <div class="amenity-content">
                ...
                <p>Experience culinary excellence at our signature restaurant featuring international cuisine prepared by award-winning chefs using locally sourced ingredients.</p>
                <div class="amenity-features">
                  <span class="feature-tag">Breakfast 6-10AM</span>
                  <span class="feature-tag">Dinner 6-11PM</span>
                </div>
              </div>
            </div>
          </div><!-- End Amenity Card -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="amenity-card">
              <div class="amenity-image">
                <img src="<?php echo base_url('assets/img/hotel/event-4.webp') ?>" alt="Conference Hall" class="img-fluid" loading="lazy">
                <div class="amenity-icon">
              ...
              <div class="amenity-content">
                ...
                <p>Host successful business meetings and special celebrations in our versatile event spaces equipped with modern audiovisual technology and catering services.</p>
                <div class="amenity-features">
                  <span class="feature-tag">Up to 200 Guests</span>
                  <span class="feature-tag">A/V Equipment</span>
                </div>
              </div>
            </div>
          </div><!-- End Amenity Card -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="amenity-card">
              <div class="amenity-image">
                <img src="<?php echo base_url('assets/img/hotel/amenities-5.webp') ?>" alt="Concierge" class="img-fluid" loading="lazy">
                <div class="amenity-icon">
              ...
              <div class="amenity-content">
                ...
                <p>Our dedicated concierge team is available around the clock to assist with reservations, local recommendations, transportation, and any special requests.</p>
                <div class="amenity-features">
                  <span class="feature-tag">24/7 Service</span>
                  <span class="feature-tag">Local Expertise</span>
                </div>
              </div>
            </div>
          </div><!-- End Amenity Card -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="amenity-card">
              <div class="amenity-image">
                <img src="<?php echo base_url('assets/img/hotel/amenities-8.webp') ?>" alt="Airport Shuttle" class="img-fluid" loading="lazy">
                <div class="amenity-icon">
              ...
              <div class="amenity-content">
                ...
                <p>Enjoy convenient complimentary airport transfers in our comfortable shuttle service. Pre-booking recommended to ensure seamless arrival and departure.</p>
                <div class="amenity-features">
                  <span class="feature-tag">Complimentary</span>
                  <span class="feature-tag">On Schedule</span>
                </div>
              </div>
            </div>
          </div><!-- End Amenity Card -->
